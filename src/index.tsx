...
const refreshGuard = async () => {
  ...
  try {
    ...
    overviewPaused = true;
    clearOverview();
    guardListeners.forEach(listener => listener({version: "1.0.0", blocked: true,
...
let overviewCache: Overview = { version: "1.0.0", standalonePlugins: [] };
...
const clearOverview = () => {
  ...
  overviewCache = { version: "1.0.0", standalonePlugins: [] };
};
